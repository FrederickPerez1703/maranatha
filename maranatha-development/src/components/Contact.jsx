          ...
          <div style={{ paddingTop: '16px' }}>
            <button
              ...
              style={{
                width: '100%',
                padding: '16px 24px',
                backgroundColor: (!formData.name || !formData.phone || !formData.date || !formData.time) ? '#d1d5db' : '#9333ea',
                color: 'white',
                fontWeight: '600',
                borderRadius: '8px',
                border: 'none',
                cursor: (!formData.name || !formData.phone || !formData.date || !formData.time) ? 'not-allowed' : 'pointer',
                display: 'flex',
                alignItems: 'center',
