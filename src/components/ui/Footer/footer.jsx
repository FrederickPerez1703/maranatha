      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              Tu salón de belleza de confianza. Transformamos tu belleza natural con técnicas profesionales y productos de alta calidad.
            </p>
            <div style={{
              display: 'flex',
              gap: '1rem'
          ...
          <div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ color: '#b0b0b0', lineHeight: '1.5' }}>
              ...
              <div style={{
                ...
                <a
                  href="mailto:info@enmaranatha.com"
                  style={{
                    color: '#b0b0b0',
                    textDecoration: 'none',
                    transition: 'color 0.3s ease'
              ...
              <div style={{
                ...
                <div style={{ color: '#b0b0b0', lineHeight: '1.5' }}>
                  <div>Lun - Sáb: 9:00 AM - 6:30 PM</div>
                  <div style={{ fontSize: '0.9rem', opacity: 0.8 }}>Domingo: Cerrado</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div style={{
          ...
          <p style={{
            ...
            © {currentYear} En Maranatha. Todos los derechos reservados.
          </p>
          <div style={{
            display: 'flex',
            gap: '1.5rem',
